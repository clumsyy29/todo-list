...
const TodoItems = () => {
  ...
  if (items.length == 0) {
    return <div className="text-red-600 font-bold text-xl">Kosong Nih</div>
  } 
  else if (filtered.length == 0 && filterMode == "Active") {
    return <div className="text-red-600 font-bold text-xl">Tidak ada kegiatan</div>
  } 
  else if (filtered.length == 0 && filterMode == "Completed") {
    return <div className="text-red-600 font-bold text-xl">Lu belum ngapa-ngapain tong</div>
  }
  return (
    <>
